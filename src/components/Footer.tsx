...
const Footer = () => {
  ...
  return (
    <footer className="bg-secondary/40 border-t border-border/50 py-16">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          {/* Brand Column */}
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center space-x-2 text-primary font-display font-bold mb-4">
            ...
            <p className="text-sm text-foreground/70 mb-6">
              The next generation voice AI platform for India. Create natural, expressive voices in all Indian languages.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 md:col-span-3">
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/voices" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Voices</Link></li>
                <li><Link to="/pricing" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Pricing</Link></li>
                <li><Link to="/api" className="text-sm text-foreground/70 hover:text-foreground transition-colors">API</Link></li>
                <li><Link to="/samples" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Audio Samples</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/documentation" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Documentation</Link></li>
                <li><Link to="/community" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Community</Link></li>
                <li><Link to="/status" className="text-sm text-foreground/70 hover:text-foreground transition-colors">Status</Link></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-border/50">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-foreground/60">
              &copy; {currentYear} Duplicate Labs India. All rights reserved.
            </p>
